namespace ApiForAuth.Helpers.Kit.Postgres
{
    using System;
    ...
    public class SqlServerHelperFluent<TEntity> : SqlServerHelperFluent
    {
        ...
        {
            return _connectionString.ExecuteSelectMany(_sqlText, isStoredProcedure: _isStoredProcedure, parameters: _parameters, converters: _converters.ToArray());
        }

        public IEnumerableWithPage<TEntity> ExecuteSelectManyWithPage()
        {
            return _connectionString.ExecuteSelectManyWithPage(_sqlText, isStoredProcedure: _isStoredProcedure, parameters: _parameters, converters: _converters.ToArray());
        }
        public IEnumerableWithOffer<TEntity> ExecuteSelectManyWithOffer()
        {
            return _connectionString.ExecuteSelectManyWithOffer(_sqlText, isStoredProcedure: _isStoredProcedure, parameters: _parameters, converters: _converters.ToArray());
        }
    }
