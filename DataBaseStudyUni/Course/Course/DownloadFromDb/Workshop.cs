...
namespace Course.DownloadFromDb
{
    public class Workshop
    {
        ...
        public void DownWork(DataGridView dataGridView1, System.Windows.Forms.ComboBox comboBox1)
        {
            ...
            comboBox1.DataSource = new BindingSource(idTitleDictionaryWork, null);
